        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerDocument(config =>
            {
                config.PostProcess = document =>
                {
                    ...
                    document.Info.Title = "ProductReader API Service";
                    document.Info.Description = "This service is to serve reading query as quesry layer in CQRS.";
